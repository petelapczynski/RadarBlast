...
public class ObstacleSpecialTime extends ObstacleSpecials implements IGameObjectSpecial {

    public ObstacleSpecialTime(float startX, float startY, float radius, int color) {
        this.radius = radius;
        ...
        spin = 0;
        image = BitmapFactory.decodeResource(Constants.CONTEXT.getResources(),R.drawable.spec_time);
    }
    ...
    public static IGameObjectSpecial GetInstance() {
        return new ObstacleSpecialTime(0,0,85, Color.WHITE);
    }
