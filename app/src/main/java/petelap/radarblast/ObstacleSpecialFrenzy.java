...
public class ObstacleSpecialFrenzy extends ObstacleSpecials implements IGameObjectSpecial {

    public ObstacleSpecialFrenzy(float startX, float startY, float radius, int color) {
        this.radius = radius;
        ...
        InGameArea = true;
        pop = false;
        image = BitmapFactory.decodeResource(Constants.CONTEXT.getResources(),R.drawable.spec_frenzy);
    ...
    public static IGameObjectSpecial GetInstance() {
        return new ObstacleSpecialFrenzy(0,0,85, Color.WHITE);
    }
