...
public class ObstacleTriangleDown extends ObstacleShapes implements IGameObject {
    private float width;
    private float height;
    private Path path;
    private PointF Left, Center, Right;

    public ObstacleTriangleDown(float width, float height, float startX, float startY, int color) {
        this.width = width;
        this.height = height;
        this.color = color;
        ...
        rect = new RectF(Left.x, Left.y, Right.x, Center.y);
    ...
    public static IGameObject GetInstance() {
        return new ObstacleTriangleDown(1,1, 0,0, Color.parseColor(Common.getPreferenceString("color_Triangle")));
    }
