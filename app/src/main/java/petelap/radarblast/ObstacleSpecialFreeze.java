...
public class ObstacleSpecialFreeze implements IGameObject {
    ...
    public ObstacleSpecialFreeze(int startX, int startY, float radius, int color) {
        this.radius = radius;
    ...
    public static IGameObject GetInstance() {
        return new ObstacleSpecialFreeze(0,0,0, Color.WHITE);
    }
