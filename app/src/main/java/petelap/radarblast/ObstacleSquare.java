...
public class ObstacleSquare extends ObstacleShapes implements IGameObject {

    public ObstacleSquare(float rectHeight, float startX, float startY, int color) {
    ...
    public static IGameObject GetInstance() {
        return new ObstacleSquare(1,0,0, Color.parseColor(Common.getPreferenceString("color_Square")));
    }
