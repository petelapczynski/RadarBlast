...
public class ObstacleSpecialSpike implements IGameObject {
    ...
    public ObstacleSpecialSpike(int startX, int startY, float radius, int color) {
        this.radius = radius;
    ...
    public static IGameObject GetInstance() {
        return new ObstacleSpecialSpike(0,0,0, Color.WHITE);
    }
